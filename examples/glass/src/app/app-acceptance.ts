...
export const appProductReadiness: ToolcraftProductReadiness = {
  ...
  productSummary:
    "A Toolcraft liquid-glass shader playground that renders a configurable SDF/WebGL glass lens with optional centered text and clipped button imagery over generated or uploaded source pixels.",
  requestedBehavior:
    "Port the samasante/liquid-glass algorithm into the Toolcraft app flow with controls for glass shape, dimensions, corner radius, opacity, drop shadow, glass-constrained texture overlay, movable centered glass text with typography, alignment, and blend mode, a user-uploaded image clipped inside the glass/button with position and scale controls, texture opacity, aberration, refraction, distortion, fisheye, frost, sheen, glow, background, and PNG export.",
};

export const appAcceptance: readonly ToolcraftComponentAcceptance[] = [
  {
    automated: true,
    automatedTestName: "reference canvas size matches liquid glass renderer",
    browser: true,
    browserTestName: "browser: canvas sizing and render scale update glass output",
    componentType: "custom-renderer",
    evidence: "rendered-pixels",
    expectedObservable:
      "The Toolcraft canvas size controls define the liquid-glass renderer and export dimensions.",
    fixture: "1920x1080 liquid glass canvas",
    id: "reference.canvasSizing",
    kind: "runtime",
    referenceCoverage: "canvas-sizing",
    target: "canvas.size",
    userAction: "Change Canvas width and Canvas height in the runtime Setup section.",
  },
  {
    automated: true,
    automatedTestName: "reference control mapping preserves liquid glass output",
    browser: true,
    browserTestName: "browser: refraction controls change product output",
    componentType: "custom-renderer",
    evidence: "product-output",
    expectedObservable:
      "Schema controls map to the same SDF displacement, RGB split, frost, and specular shader behavior as the reference runtime.",
    fixture: "reference optics defaults",
    id: "reference.controlMapping",
    kind: "runtime",
    referenceCoverage: "control-mapping",
    target: "glass.referenceControls",
    userAction: "Change mapped glass controls and observe the shader output.",
  },
  {
    automated: true,
    automatedTestName: "reference renderer state preserves liquid glass lifecycle",
    browser: true,
    browserTestName: "browser: refraction controls change product output",
    componentType: "custom-renderer",
    evidence: "product-output",
    expectedObservable:
      "The WebGL program, source texture, displacement map, and uniform state update without replacing the Toolcraft shell.",
    fixture: "cached WebGL renderer",
    id: "reference.rendererState",
    kind: "runtime",
    referenceCoverage: "renderer-state",
    target: "glass.rendererState",
    userAction: "Move from shape-changing controls to uniform-only controls.",
  },
  {
    automated: true,
    automatedTestName: "canvas aspect ratio changes glass output size",
    browser: true,
    browserTestName: "browser: canvas sizing and render scale update glass output",
    componentType: "aspectRatio",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Aspect ratio updates the canvas size and reframes the glass output.",
    fixture: "aspect-ratio runtime setup",
    id: "canvas.aspectRatio",
    kind: "control",
    target: "canvas.aspectRatio",
    userAction: "Choose a different Aspect ratio preset.",
  },
  {
    automated: true,
    automatedTestName: "canvas width changes glass output size",
    browser: true,
    browserTestName: "browser: canvas sizing and render scale update glass output",
    componentType: "text",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Canvas width updates the renderer backing size and product output dimensions.",
    fixture: "editable output width",
    id: "canvas.size.width",
    kind: "control",
    target: "canvas.size.width",
    userAction: "Edit Canvas width and commit the field.",
  },
  {
    automated: true,
    automatedTestName: "canvas height changes glass output size",
    browser: true,
    browserTestName: "browser: canvas sizing and render scale update glass output",
    componentType: "text",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Canvas height updates the renderer backing size and product output dimensions.",
    fixture: "editable output height",
    id: "canvas.size.height",
    kind: "control",
    target: "canvas.size.height",
    userAction: "Edit Canvas height and commit the field.",
  },
  {
    automated: true,
    automatedTestName: "resolution scale changes preview backing pixels",
    browser: true,
    browserTestName: "browser: canvas sizing and render scale update glass output",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Resolution scale changes preview backing pixels without changing CSS output size.",
    fixture: "render scale runtime setup",
    id: "canvas.renderScale",
    kind: "control",
    target: "canvas.renderScale",
    userAction: "Drag Resolution scale in the runtime Setup section.",
  },
  {
    automated: true,
    automatedTestName: "settings transfer exports and imports liquid glass settings",
    browser: true,
    browserTestName: "browser: settings transfer buttons are available for complex glass settings",
    componentType: "settingsTransfer",
    evidence: "command-side-effect",
    expectedObservable:
      "The runtime Settings export/import section is available because the app exceeds the settings-transfer threshold.",
    fixture: "complex liquid glass controls",
    id: "runtime.settingsTransfer",
    kind: "control",
    target: "runtime.settingsTransfer",
    userAction: "Use the runtime Export Settings and Import Settings controls.",
  },
  {
    automated: true,
    automatedTestName: "persistence restores liquid glass settings after reload",
    browser: true,
    browserTestName: "browser: persistence restores glass settings after reload",
    componentType: "persistence",
    evidence: "persistence-state",
    expectedObservable:
      "A changed glass value survives a real browser reload through runtime localStorage persistence.",
    fixture: "localStorage glass state",
    id: "runtime.persistence",
    kind: "runtime",
    persistenceCoverage: "reload",
    target: "runtime.persistence",
    userAction: "Change Strength, reload the page, and verify the setting/output is restored.",
  },
  {
    automated: true,
    automatedTestName: "source image upload clear and reset update liquid glass media",
    browser: true,
    browserTestName: "browser: source image upload clear and reset update media",
    componentType: "fileDrop",
    evidence: "media-lifecycle",
    expectedObservable:
      "First load shows the built-in flow-gradient source image as a real file preview; uploading a source image changes the refracted source, keeps the current Toolcraft canvas dimensions, draws the source with contain-fit over the product background, and exposes runtime image transform actions; Clear removes the source image from preview and canvas, while section reset and global Reset restore the built-in default source.",
    fixture: "default flow-gradient PNG, uploaded SVG source image, portrait source, and image transform actions",
    id: "source.upload",
    kind: "control",
    target: "source.upload",
    userAction:
      "Confirm the built-in source preview is visible, upload a source image, use image transform actions, upload a portrait source and confirm the canvas dimensions stay fixed while the source covers the canvas, clear it and confirm no source preview remains, then upload again and use section reset and Reset controls to restore the built-in default source.",
  },
  {
    automated: true,
    automatedTestName: "source saturation changes liquid glass output",
    browser: true,
    browserTestName: "browser: source controls and upload update product output",
    componentType: "slider",
    evidence: "product-output",
    expectedObservable:
      "Changing Saturation changes the source color texture sampled by the shader.",
    fixture: "uploaded source image",
    id: "source.saturation",
    kind: "control",
    target: "source.saturation",
    userAction: "Drag the Saturation slider.",
  },
  {
    automated: true,
    automatedTestName: "glass shape changes rendered output",
    browser: true,
    browserTestName: "browser: glass shape controls change product output",
    componentType: "select",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Shape resolves different lens geometry and changes the rendered rounded silhouette.",
    fixture: "glass shape variants",
    id: "glass.shape",
    kind: "control",
  ...
  {
    automated: true,
    automatedTestName: "glass width changes rendered output",
    browser: true,
    browserTestName: "browser: glass shape controls change product output",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Width changes the lens SDF aspect and visible glass footprint.",
    fixture: "wide lens",
    id: "glass.width",
    kind: "control",
    target: "glass.width",
  ...
  {
    automated: true,
    automatedTestName: "glass height changes rendered output",
    browser: true,
    browserTestName: "browser: glass shape controls change product output",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Height changes the lens SDF aspect and visible glass footprint.",
    fixture: "tall lens",
    id: "glass.height",
    kind: "control",
    target: "glass.height",
  ...
  {
    automated: true,
    automatedTestName: "glass radius changes rendered output",
    browser: true,
    browserTestName: "browser: glass shape controls change product output",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Radius changes the corner SDF and visible lens edge.",
    fixture: "corner radius fixture",
    id: "glass.radius",
    kind: "control",
    target: "glass.radius",
  ...
  {
    automated: true,
    automatedTestName: "glass center vector changes rendered output",
    browser: true,
    browserTestName: "browser: glass shape controls change product output",
    ...
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Center X and Y moves the lens over different source pixels in the same horizontal and vertical direction as the vector pad.",
    fixture: "center vector fixture",
    id: "glass.center",
    kind: "control",
    target: "glass.center",
    userAction: "Move both Center vector axes.",
  },
  {
    automated: true,
    automatedTestName: "glass direct canvas drag changes rendered output",
    browser: true,
    browserTestName: "browser: dragging glass on canvas moves lens output",
    componentType: "canvas-drag",
    evidence: "rendered-pixels",
    expectedObservable:
      "The on-canvas glass drag zone previews movement immediately, updates the Center setting while the pointer is still down, keeps the Center pad direction aligned with the canvas movement, and changes rendered pixels.",
    fixture: "direct glass drag fixture",
    id: "glass.center.directDrag",
    kind: "runtime",
    target: "glass.center",
    userAction: "Press the visible glass area on the canvas and drag it to a new position.",
  },
  {
    automated: true,
    automatedTestName: "glass opacity changes rendered output",
    browser: true,
    browserTestName: "browser: glass settings apply while dragging controls",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Dragging Opacity updates rendered glass while the pointer is still down and blends the lens toward the untouched source.",
    fixture: "opacity fixture",
    id: "glass.opacity",
    kind: "control",
    target: "glass.opacity",
    userAction: "Drag the Opacity slider and observe output before releasing the pointer.",
  },
  {
    automated: true,
    automatedTestName: "glass shadow include changes rendered output",
    browser: true,
    browserTestName: "browser: glass shadow controls change product output",
    componentType: "switch",
    evidence: "rendered-pixels",
    expectedObservable:
      "Toggling Include shows or hides the shader drop shadow behind the glass.",
    fixture: "glass shadow include fixture",
    id: "shadow.enabled",
    kind: "control",
    target: "shadow.enabled",
    userAction: "Toggle Include in the Glass Shadow section.",
  },
  {
    automated: true,
    automatedTestName: "glass shadow offset changes rendered output",
    browser: true,
    browserTestName: "browser: glass shadow controls change product output",
    componentType: "vector",
    controlPartCoverage: ["vector.x", "vector.y"],
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Offset moves the drop shadow in the same horizontal and vertical direction as the vector pad.",
    fixture: "glass shadow offset fixture",
    id: "shadow.offset",
    kind: "control",
    target: "shadow.offset",
    userAction: "Move both Offset vector axes in the Glass Shadow section.",
  },
  {
    automated: true,
    automatedTestName: "glass shadow color changes rendered output",
    browser: true,
    browserTestName: "browser: glass shadow controls change product output",
    ...
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Color hex and opacity updates the shader drop shadow tint and alpha.",
    fixture: "glass shadow color fixture",
    id: "shadow.color",
    kind: "control",
    target: "shadow.color",
    userAction: "Change the Glass Shadow Color hex and opacity controls.",
  },
  {
    automated: true,
    automatedTestName: "glass shadow blur changes rendered output",
    browser: true,
    browserTestName: "browser: glass shadow controls change product output",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Blur softens or tightens the WebGL drop shadow behind the lens.",
    fixture: "glass shadow blur fixture",
    id: "shadow.blur",
    kind: "control",
    target: "shadow.blur",
    userAction: "Drag the Blur slider in the Glass Shadow section.",
  },
  {
    automated: true,
    automatedTestName: "glass text include changes rendered output",
    browser: true,
    browserTestName: "browser: glass text controls change product output",
    componentType: "switch",
    evidence: "rendered-pixels",
    expectedObservable:
      "Toggling Include shows or hides text composited inside the glass shape.",
    fixture: "glass text include fixture",
    id: "text.enabled",
    kind: "control",
    target: "text.enabled",
    userAction: "Toggle Include in the Glass Text section.",
  },
  {
    automated: true,
    automatedTestName: "glass text drag target changes canvas behavior",
    browser: true,
    browserTestName: "browser: moving glass text on canvas changes text output",
    componentType: "select",
    evidence: "rendered-pixels",
    expectedObservable:
      "Choosing Text in the Drag control makes the canvas drag move only the glass text while the glass lens center stays stable, and Drag is hidden/unavailable when Include is off.",
    fixture: "glass text drag target fixture",
    id: "text.dragTarget",
    kind: "control",
    optionCoverage: "each-visible-item",
    target: "text.dragTarget",
    userAction:
      "Choose Text in the Drag select control, drag the glass on the canvas, then return to Glass and confirm Drag is hidden/unavailable when Include is off.",
  },
  {
    automated: true,
    automatedTestName: "glass text offset changes rendered output",
    browser: true,
    browserTestName: "browser: moving glass text on canvas changes text output",
    componentType: "vector",
    controlPartCoverage: ["vector.x", "vector.y"],
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Offset moves the text texture inside the glass mask on both axes in the same direction as the vector pad and canvas text drag, and the control is hidden/unavailable when Include is off.",
    fixture: "glass text offset fixture",
    id: "text.offset",
    kind: "control",
    target: "text.offset",
    userAction:
      "Move the Offset vector X/Y value and drag the text on the canvas while Drag is set to Text, then turn Include off and confirm Offset is hidden/unavailable.",
  },
  {
    automated: true,
    automatedTestName: "glass text content changes rendered output",
    browser: true,
    browserTestName: "browser: glass text controls change product output",
    componentType: "text",
    evidence: "rendered-pixels",
    expectedObservable:
      "Editing Text redraws the centered text texture inside the glass mask, and the control is hidden/unavailable when Include is off.",
    fixture: "glass text content fixture",
    id: "text.content",
    kind: "control",
    target: "text.content",
    userAction: "Type a new glass text label, then turn Include off and confirm Text is hidden/unavailable.",
  },
  {
    automated: true,
    automatedTestName: "glass text style changes rendered output",
    browser: true,
    browserTestName: "browser: glass text controls change product output",
    ...
    evidence: "rendered-pixels",
    expectedObservable:
      "FontPicker changes font family, weight, size, letter spacing, line height, case, color, and opacity on the actual glass text, and Style is hidden/unavailable when Include is off.",
    fixture: "glass text typography fixture",
    id: "text.style",
    kind: "control",
    target: "text.style",
    userAction:
      "Change the Glass Text Style font, weight, size, case, color, opacity, letter spacing, and line height, then turn Include off and confirm Style is hidden/unavailable.",
  },
  {
    automated: true,
    automatedTestName: "glass text blend mode changes rendered output",
    browser: true,
    browserTestName: "browser: glass text controls change product output",
    componentType: "select",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Blend alters how the glass text combines with refracted pixels, and Text Blend is hidden/unavailable when Include is off.",
    fixture: "glass text blend modes",
    id: "text.blendMode",
    kind: "control",
    optionCoverage: "each-visible-item",
    target: "text.blendMode",
    userAction: "Choose each Glass Text Blend option, then turn Include off and confirm Text Blend is hidden/unavailable.",
  },
  {
    automated: true,
    automatedTestName: "glass text horizontal alignment changes rendered output",
    browser: true,
    browserTestName: "browser: glass text controls change product output",
    componentType: "select",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Horizontal moves the text block left, center, or right inside the glass shape, and the control is hidden/unavailable when Include is off.",
    fixture: "glass text horizontal alignment",
    id: "text.alignX",
    kind: "control",
    optionCoverage: "each-visible-item",
    target: "text.alignX",
    userAction: "Choose Left, Center, and Right horizontal alignment, then turn Include off and confirm Horizontal is hidden/unavailable.",
  },
  {
    automated: true,
    automatedTestName: "glass text vertical alignment changes rendered output",
    browser: true,
    browserTestName: "browser: glass text controls change product output",
    componentType: "select",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Vertical moves the text block top, center, or bottom inside the glass shape, and the control is hidden/unavailable when Include is off.",
    fixture: "glass text vertical alignment",
    id: "text.alignY",
    kind: "control",
    optionCoverage: "each-visible-item",
    target: "text.alignY",
    userAction: "Choose Top, Center, and Bottom vertical alignment, then turn Include off and confirm Vertical is hidden/unavailable.",
  },
  {
    automated: true,
    automatedTestName: "button image upload clear and reset update glass content",
    browser: true,
    browserTestName: "browser: button image upload position and scale update glass output",
    componentType: "fileDrop",
    evidence: "media-lifecycle",
    expectedObservable:
      "First load shows the built-in icon.png as a real Button Image preview; uploading replaces it, Remove image clears only the button image, and section reset/global Reset restore the default icon without removing the source or glass texture assets.",
    fixture: "default icon plus uploaded SVG button image",
    id: "buttonImage.upload",
    kind: "control",
    target: "buttonImage.upload",
    userAction:
      "Confirm the built-in icon preview appears, upload a replacement button image, remove it, upload again, then use Button Image section reset and global Reset to restore the default icon only.",
  },
  {
    automated: true,
    automatedTestName: "button image blend mode changes rendered output",
    browser: true,
    browserTestName: "browser: button image upload position and scale update glass output",
    componentType: "select",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Blend alters how the uploaded button image mixes with the refracted glass pixels while staying clipped to the glass shape.",
    fixture: "uploaded button image blend modes",
    id: "buttonImage.blendMode",
    kind: "control",
    optionCoverage: "each-visible-item",
    target: "buttonImage.blendMode",
    userAction: "Upload a button image and choose each Button Image Blend option.",
  },
  {
    automated: true,
    automatedTestName: "button image position changes rendered output",
    browser: true,
    browserTestName: "browser: button image upload position and scale update glass output",
    componentType: "vector",
    controlPartCoverage: ["vector.x", "vector.y"],
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Position moves the uploaded image within the glass mask on both axes without moving the lens or source background.",
    fixture: "uploaded button image position fixture",
    id: "buttonImage.offset",
    kind: "control",
    target: "buttonImage.offset",
    userAction: "Upload a button image and move both Position vector axes.",
  },
  {
    automated: true,
    automatedTestName: "button image scale changes rendered output",
    browser: true,
    browserTestName: "browser: button image upload position and scale update glass output",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Dragging Scale resizes the uploaded image inside the glass mask live while preserving the lens position and shader quality.",
    fixture: "uploaded button image scale fixture",
    id: "buttonImage.scale",
    kind: "control",
    target: "buttonImage.scale",
    userAction: "Upload a button image and drag the Scale slider.",
  },
  {
    automated: true,
    automatedTestName: "texture mode changes glass surface overlay",
    browser: true,
    browserTestName: "browser: glass texture controls change product output",
    componentType: "segmented",
    evidence: "product-output",
    expectedObservable:
      "Switching Texture between Off, Preset, and Image changes whether a surface material is composited inside the glass mask.",
    fixture: "glass texture mode variants",
    id: "texture.mode",
    kind: "control",
    optionCoverage: "each-visible-item",
    target: "texture.mode",
    userAction: "Choose Texture Preset, Image, and Off while observing the glass output.",
  },
  {
    automated: true,
    automatedTestName: "texture pattern changes glass surface overlay",
    browser: true,
    browserTestName: "browser: glass texture controls change product output",
    componentType: "select",
    evidence: "product-output",
    expectedObservable:
      "Changing Pattern redraws the generated overlay texture and the control is visible for Texture Preset but hidden when Texture is Off or Image.",
    fixture: "generated glass texture patterns",
    id: "texture.preset",
    kind: "control",
    optionCoverage: "each-visible-item",
    target: "texture.preset",
    userAction:
      "Choose Texture Preset, select each Pattern, then switch Texture to Off or Image and confirm Pattern is hidden/unavailable.",
  },
  {
    automated: true,
    automatedTestName: "texture image upload clear and reset update glass overlay",
    browser: true,
    browserTestName: "browser: glass texture image upload clear and reset update media",
    componentType: "fileDrop",
    evidence: "media-lifecycle",
    expectedObservable:
      "First load shows the built-in scratch texture as a real file preview; uploading a texture image changes only the glass overlay; Texture Image is visible for Texture Image mode and hidden when Texture is Off or Preset; Clear removes the overlay media, while section reset and global Reset restore the built-in default texture.",
    fixture: "uploaded SVG texture image",
    id: "texture.upload",
    kind: "control",
    target: "texture.upload",
    userAction:
      "Show Texture Image by choosing Texture Image, confirm the built-in texture preview is visible, upload an overlay image, clear it and confirm no texture preview remains, upload again, use section reset and Reset controls to restore the built-in default texture, then return to Off so upload is hidden/unavailable.",
  },
  {
    automated: true,
    automatedTestName: "texture blend mode changes glass surface overlay",
    browser: true,
    browserTestName: "browser: glass texture controls change product output",
    componentType: "select",
    evidence: "product-output",
    expectedObservable:
      "Changing Blend changes how the texture pixels combine with refracted glass pixels, and the control is hidden when Texture is Off.",
    fixture: "glass texture blend modes",
    id: "texture.blendMode",
    kind: "control",
    optionCoverage: "each-visible-item",
    target: "texture.blendMode",
    userAction:
      "Choose Texture Preset or Image, select each Blend mode, then switch Texture Off and confirm Blend is hidden/unavailable.",
  },
  {
    automated: true,
    automatedTestName: "texture opacity changes glass surface overlay",
    browser: true,
    browserTestName: "browser: glass texture controls change product output",
    componentType: "slider",
    evidence: "product-output",
    expectedObservable:
      "Changing Texture Opacity adjusts only the masked texture overlay strength and the control is hidden when Texture is Off.",
    fixture: "glass texture opacity fixture",
    id: "texture.opacity",
    kind: "control",
    target: "texture.opacity",
    userAction:
      "Choose Texture Preset or Image, drag Texture Opacity, then switch Texture Off and confirm the control is hidden/unavailable.",
  },
  {
    automated: true,
    automatedTestName: "strength changes refraction output",
    browser: true,
    browserTestName: "browser: refraction controls change product output",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Strength changes displacement scale in the shader.",
    fixture: "strength fixture",
    id: "glass.strength",
    kind: "control",
  ...
  {
    automated: true,
    automatedTestName: "depth changes refraction output",
    browser: true,
    browserTestName: "browser: refraction controls change product output",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Depth changes how far the SDF displacement reaches into the lens.",
  ...
  {
    automated: true,
    automatedTestName: "curvature changes refraction output",
    browser: true,
    browserTestName: "browser: refraction controls change product output",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Curvature changes the dome constants used by the SDF map.",
    fixture: "curvature fixture",
    id: "glass.curvature",
    kind: "control",
    target: "glass.curvature",
    userAction: "Drag the Curvature slider.",
  },
  {
    automated: true,
    automatedTestName: "fisheye changes refraction output",
    browser: true,
    browserTestName: "browser: refraction controls change product output",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Fisheye changes the extra radial displacement uniform.",
    fixture: "fisheye fixture",
    id: "glass.fisheye",
    kind: "control",
    target: "glass.fisheye",
    userAction: "Drag the Fisheye slider.",
  },
  {
    automated: true,
    automatedTestName: "aberration changes refraction output",
    browser: true,
    browserTestName: "browser: refraction controls change product output",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Aberration changes the red/green/blue displacement split.",
    fixture: "chromatic aberration fixture",
    id: "glass.dispersion",
    kind: "control",
    target: "glass.dispersion",
    userAction: "Drag the Aberration slider.",
  },
  {
    automated: true,
    automatedTestName: "splay changes refraction output",
    browser: true,
    browserTestName: "browser: refraction controls change product output",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Splay changes corner displacement direction in the map.",
    fixture: "splay fixture",
    id: "glass.splay",
    kind: "control",
    target: "glass.splay",
    userAction: "Drag the Splay slider.",
  },
  {
    automated: true,
    automatedTestName: "edge bend changes rendered output",
    browser: true,
    browserTestName: "browser: edge and surface controls change product output",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Bend changes the rim meniscus displacement.",
    fixture: "edge bend fixture",
    id: "glass.bend",
    kind: "control",
    target: "glass.bend",
    userAction: "Drag the Bend slider.",
  },
  {
    automated: true,
    automatedTestName: "edge width changes rendered output",
    browser: true,
    browserTestName: "browser: edge and surface controls change product output",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Edge Width changes the meniscus band width.",
    fixture: "edge width fixture",
    id: "glass.bendWidth",
    kind: "control",
    target: "glass.bendWidth",
    userAction: "Drag the Edge Width slider.",
  },
  {
    automated: true,
    automatedTestName: "frost changes rendered output",
    browser: true,
    browserTestName: "browser: edge and surface controls change product output",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Frost changes the WebGL blur prepass and frosted lens mix.",
    fixture: "frost fixture",
    id: "glass.frost",
    kind: "control",
    target: "glass.frost",
    userAction: "Drag the Frost slider.",
  },
  {
    automated: true,
    automatedTestName: "brightness changes rendered output",
    browser: true,
    browserTestName: "browser: edge and surface controls change product output",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Brightness changes the white/black veil over the lens.",
    fixture: "brightness fixture",
    id: "glass.brightness",
    kind: "control",
    target: "glass.brightness",
    userAction: "Drag the Brightness slider.",
  },
  {
    automated: true,
    automatedTestName: "murkiness changes rendered output",
    browser: true,
    browserTestName: "browser: edge and surface controls change product output",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Murkiness changes the milky glass veil.",
    fixture: "murkiness fixture",
    id: "glass.murkiness",
    kind: "control",
    target: "glass.murkiness",
    userAction: "Drag the Murkiness slider.",
  },
  {
    automated: true,
    automatedTestName: "specular changes highlight output",
    browser: true,
    browserTestName: "browser: highlight controls change product output",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Specular changes B-channel highlight lift.",
    fixture: "specular fixture",
    id: "glass.specular",
    kind: "control",
    target: "glass.specular",
    userAction: "Drag the Specular slider.",
  },
  {
    automated: true,
    automatedTestName: "sheen changes highlight output",
    browser: true,
    browserTestName: "browser: highlight controls change product output",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Sheen changes directional highlight intensity.",
    fixture: "sheen fixture",
    id: "glass.sheen",
    kind: "control",
    target: "glass.sheen",
    userAction: "Drag the Sheen slider.",
  },
  {
    automated: true,
    automatedTestName: "sheen thickness changes highlight output",
    browser: true,
    browserTestName: "browser: highlight controls change product output",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Thickness changes the highlight band in the SDF map.",
    fixture: "sheen width fixture",
    id: "glass.sheenWidth",
    kind: "control",
  ...
  {
    automated: true,
    automatedTestName: "sheen angle changes highlight output",
    browser: true,
    browserTestName: "browser: highlight controls change product output",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Angle moves the directional specular highlight.",
    fixture: "sheen angle fixture",
    id: "glass.sheenAngle",
    kind: "control",
    target: "glass.sheenAngle",
    userAction: "Drag the Angle slider.",
  },
  {
    automated: true,
    automatedTestName: "glow changes highlight output",
    browser: true,
    browserTestName: "browser: highlight controls change product output",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Glow changes the inner specular mask.",
    fixture: "glow fixture",
    id: "glass.glow",
    kind: "control",
    target: "glass.glow",
    userAction: "Drag the Glow slider.",
  },
  {
    automated: true,
    automatedTestName: "glow spread changes highlight output",
    browser: true,
    browserTestName: "browser: highlight controls change product output",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Spread changes how far the inner glow reaches.",
    fixture: "glow spread fixture",
    id: "glass.glowSpread",
    kind: "control",
  ...
  },
  {
    ...
    browser: true,
    browserTestName: "browser: background controls affect preview and png export",
    componentType: "switch",
    evidence: "rendered-pixels",
    expectedObservable:
      "Turning Include off hides the renderer-owned background in preview/canvas, produces transparent PNG alpha pixels, and the video export contract keeps the background if a video action exists.",
    fixture: "transparent background fixture",
    id: "export.includeBackground",
    kind: "control",
    target: "export.includeBackground",
    userAction: "Toggle Include off, verify preview background is hidden, export transparent PNG, and keep video background behavior documented.",
  },
  {
    automated: true,
    ...
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Background color changes preview and exported background pixels.",
    fixture: "background color fixture",
    id: "appearance.background",
    kind: "control",
    target: "appearance.background",
    userAction: "Change the Background color.",
  },
  {
    automated: true,
    automatedTestName: "image format changes exported file type",
    browser: true,
    browserTestName: "browser: image export writes final glass output",
    componentType: "select",
    evidence: "exported-bytes",
    expectedObservable:
      "Changing Format changes the exported image MIME/container.",
    fixture: "png and jpg export fixture",
    id: "export.image.format",
    kind: "control",
    optionCoverage: "each-visible-item",
    target: "export.image.format",
    userAction: "Choose PNG and JPG before exporting.",
  },
  {
    automated: true,
    ...
    evidence: "exported-bytes",
    expectedObservable:
      "Changing Resolution changes exported image pixel dimensions at 2K, 4K, and 8K.",
    fixture: "2K 4K 8K export fixture",
    id: "export.image.resolution",
    kind: "control",
    optionCoverage: "each-visible-item",
    target: "export.image.resolution",
    userAction: "Choose multiple image export resolutions and export.",
  },
  {
    actionCoverage: ["export-png"],
    automated: true,
    automatedTestName: "export png outputs liquid glass bytes",
    browser: true,
    browserTestName: "browser: image export writes final glass output",
    componentType: "panelActions",
    evidence: "exported-bytes",
    expectedObservable:
      "Export PNG returns a real pending action and downloads final liquid-glass pixels at the selected resolution.",
    fixture: "final liquid glass export",
    id: "panel.actions",
    kind: "control",
    target: "panel.actions",
    userAction: "Click Export PNG in the sticky footer.",
  },
  {
    automated: true,
    automatedTestName: "toolbar zoom and center keep liquid glass viewport stable",
    browser: true,
    browserTestName: "browser: toolbar viewport controls keep glass output stable",
    componentType: "toolbar",
    evidence: "viewport-side-effect",
    expectedObservable:
      "Toolbar zoom and center controls change viewport state without changing product pixels or canvas size unexpectedly.",
    fixture: "toolbar viewport fixture",
    id: "toolbar.viewport",
    kind: "runtime",
    target: "toolbar.viewport",
    userAction: "Use toolbar Zoom in, Zoom out, and Center canvas.",
  },
];

const defaultNewToolcraftTransferMode: ToolcraftTransferMode = {
  animationIntent: { mode: "none" },
  mode: "new-toolcraft-app",
};
...
function getToolcraftControlSectionGroupingErrors(
  ...
  for (const item of visibleControls) {
    for (const [conditionName, condition] of [
      ...
      if (
        !gateControl ||
        gateControl.sectionLabel === item.sectionLabel ||
      ...
      errors.push(
        `${item.sectionLabel} / ${item.controlId} is gated by ${conditionName} target "${condition.target}" in ${gateControl.sectionLabel}, but both controls edit "${item.loosePrefix}". Keep mode/type/source selectors and their dependent controls in one semantic section; use visibleWhen/disabledWhen inside that section instead of splitting branch controls into their own section.`,
      );
    }
  }
...
export function validateToolcraftAcceptanceCoverage(
  ...
  transferMode: ToolcraftTransferMode =
    schema === appSchema ? appTransferMode : defaultNewToolcraftTransferMode,
): string[] {
  const errors: string[] = [];
  ...
  const appPersistenceKey =
    appSchema.persistence.storage === "localStorage" ? appSchema.persistence.key : "";
  const shouldValidateLocalStoragePersistence =
    schema.persistence.storage === "localStorage"
      ? schema === appSchema ||
        schema.persistence.key !== appPersistenceKey ||
        acceptance.some((entry) => entry.persistenceCoverage === "reload")
      : false;

  if (shouldValidateLocalStoragePersistence) {
  ...
  for (const { control, controlId, sectionTitle } of controls) {
    ...
    if (isSliderLikeControl(control)) {
      ...
      if (control.unit === "x" && control.target !== "canvas.renderScale") {
        errors.push(
