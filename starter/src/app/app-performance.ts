...
const sliderDefinitions = [
  ...
  { defaultValue: 0, label: "Kill below", max: 1, min: 0, target: "particle.killBelowWidth", workload: true },
  ...
  { defaultValue: 0.02, label: "Chance", max: 1, min: 0, target: "particle.dotChance", workload: true },
