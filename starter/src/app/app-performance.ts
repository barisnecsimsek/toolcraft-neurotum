...
const sliderDefinitions = [
  ...
  { defaultValue: 0.9, label: "Max width", max: 1, min: 0.1, target: "particle.maxColumnWidth", workload: true },
  { defaultValue: 0.05, label: "Column gap", max: 0.5, min: 0, target: "particle.columnGap", workload: true },
  { defaultValue: 0, label: "Row gap", max: 0.9, min: 0, target: "particle.rowGap", workload: true },
  { defaultValue: 1, label: "Width", max: 1, min: 0.1, target: "particle.width", workload: true },
  { defaultValue: 0, label: "Minimum width", max: 0.5, min: 0, target: "particle.minWidth", workload: true },
  { defaultValue: 0.3, label: "Shrink threshold", max: 1, min: 0, target: "particle.shrinkThreshold", workload: true },
  { defaultValue: 0.7, label: "Maximum shrink", max: 1, min: 0, target: "particle.maxShrink", workload: true },
